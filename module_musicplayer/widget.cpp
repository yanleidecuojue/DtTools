...
void Widget::initUI()
{
    ...
    QIcon btnStop_Icon;
    btnStop_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/broadcastnow.png"));
...
void Widget::on_btnSound_clicked()
{
    //静音控制
...
void Widget::on_sliderVolumn_valueChanged(int value)
{
    //调整音量
...
void Widget::on_sliderPosition_valueChanged(int value)
{
   //文件进度调控
