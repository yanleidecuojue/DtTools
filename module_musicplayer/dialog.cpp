...
void Dialog::initUI()
{
    ...
    QIcon btnAdd_Icon;
    btnAdd_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/add.png"));
    btnAdd->setIcon(btnAdd_Icon);
    btnAdd->setLayoutDirection(Qt::LeftToRight);
    btnRemove = new QPushButton(tr("移除"));
    QIcon btnRemove_Icon;
    btnRemove_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/remove.png"));
    btnRemove->setIcon(btnRemove_Icon);
    btnRemove->setLayoutDirection(Qt::LeftToRight);
    btnClear = new QPushButton(tr("清空"));
    QIcon btnClear_Icon;
    btnClear_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/clear.png"));
    ...
    QIcon btnPlay_Icon;
    btnPlay_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/broadcast.png"));
    btnPlay->setIcon(btnPlay_Icon);
    btnStop = new QPushButton;
    QIcon btnStop_Icon;
    btnStop_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/broadcast_now.png"));
    btnStop->setIcon(btnStop_Icon);
    btnPause = new QPushButton;
    QIcon btnPause_Icon;
    btnPause_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/pause.png"));
    btnPause->setIcon(btnPause_Icon);
    btnPrevious = new QPushButton;
    QIcon btnPrevious_Icon;
    btnPrevious_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/previous.png"));
    btnPrevious->setIcon(btnPrevious_Icon);
    btnNext = new QPushButton;
    QIcon btnNext_Icon;
    btnNext_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/next.png"));
    btnNext->setIcon(btnNext_Icon);
    btnSound = new QPushButton;
    QIcon btnSound_Icon;
    btnSound_Icon.addFile(tr(":/module_musicplayer_icons/module_musicplayer_icons/volumn.png"));
...
void Dialog::onPlaylistChanged(int position)
{
    //播放列表变化,更新当前播放文件名显示
...
void Dialog::on_btnSound_clicked()
{
    //静音控制
    bool mute=player->isMuted();
    player->setMuted(!mute);
    if (mute)
        btnSound->setIcon(QIcon(":/module_musicplayer_icons/module_musicplayer_icons/volumn.png"));
    else
        btnSound->setIcon(QIcon(":/module_musicplayer_icons/module_musicplayer_icons/mute.png"));
}

void Dialog::on_sliderVolumn_valueChanged(int value)
{
    //调整音量
...
void Dialog::on_sliderPosition_valueChanged(int value)
{
   //文件进度调控
